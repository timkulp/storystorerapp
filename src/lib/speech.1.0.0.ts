        ...
        (function (SpeechRecognition) {
            ...
            (function (SpeechRecognitionServiceFactory) {
                ...
                function createDataClientWithIntent(language, primaryKey, luisAppId, luisSubscriptionId) {
                    var prefs : any = createPrefs(SpeechRecognition.SpeechRecognitionMode.shortPhrase, language, primaryKey);
...
(function (Bing) {
    ...
    var Synthesis = (function () {
        ...
        Synthesis.prototype.createEvent = function (type, target) {
            var e : any = document.createEvent("UIEvent");
    ...
    var Guid : any = (function () {
        function Guid():void { }
        Guid.prototype.generateString = function generateString() {
            return Guid.prototype.getRnd4HexOctet() + Guid.prototype.getRnd4HexOctet() + "-" + Guid.prototype.getRnd4HexOctet() + "-" + Guid.prototype.getRndGuidTimeHiAndVersionHex() + "-" + Guid.prototype.getRndGuidClockSeqHiAndReservedHex() + "-" + Guid.prototype.getRnd4HexOctet() + Guid.prototype.getRnd4HexOctet() + Guid.prototype.getRnd4HexOctet();
        };
        Guid.prototype.generate16bitRnd = function generate16bitRnd() {
            return Math.random() * 0x10000 | 0;
        };
        Guid.prototype.getRnd4HexOctet = function getRnd4HexOctet() {
            return ("0000" + Guid.prototype.generate16bitRnd().toString(16)).slice(-4);
        };
        Guid.prototype.getRndGuidTimeHiAndVersionHex = function getRndGuidTimeHiAndVersionHex() {
            return (Guid.prototype.generate16bitRnd() & 0x0FFF | 0x4000).toString(16);
        };
        Guid.prototype.getRndGuidClockSeqHiAndReservedHex = function getRndGuidClockSeqHiAndReservedHex() {
            return (Guid.prototype.generate16bitRnd() & 0x3FFF | 0x8000).toString(16);
        };
        return Guid;
    })();
    Bing.Guid = Guid;    
    ...
    var LuisClient = (function () {
        ...
        LuisClient.prototype.kServiceUrl = "https://api.projectoxford.ai/luis/v1/application?subscription-key=";
        LuisClient.prototype.getIntent = function (text) {
            var task = new Task();
            var request = new XMLHttpRequest();
            request.open('GET', [
                LuisClient.prototype.kServiceUrl, 
    ...
    var HTTPResultStatus : any = (function () {
        function HTTPResultStatus() { }
        HTTPResultStatus.prototype.SUCCESS = "success";
        HTTPResultStatus.prototype.ERROR = "error";
        return HTTPResultStatus;
    })();    
    var HttpClient : any = (function () {
    ...
    var NaclClient : any = (function () {
        function NaclClient() {
            ...
            if (devMode() === true) {
                ...
                var port = chrome.runtime.connect(NaclClient.prototype.kKeyId);
        ...
        NaclClient.prototype.kKeyId = "jffoigoenpgbgnhpchggjapfijhffghe";
    ...
    function createSpeech() {
        ...
        if (useHttp()) {
            ...
            if (Platform.supportsPPAPI()) {
                ...
                var npPlugin : HTMLElement = document.createElement("embed");
                var promise = new Task();
                (npPlugin).setAttribute("type","application/x-bingspeech");
                (npPlugin).setAttribute("data","data:application/x-bingspeech,");
